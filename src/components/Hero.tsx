...
export const Hero = ({ onContactClick }: HeroProps) => {
  return (
    <section className="relative min-h-[60vh] flex items-center justify-center px-6 pt-24 pb-2 bg-gradient-subtle overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10 animate-fade-in mb-20">
        <h1 className="hero-title text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-foreground mb-6 mt-24">
